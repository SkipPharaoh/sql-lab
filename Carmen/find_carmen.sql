...
-- Holy See (Vatican City State) -- is the least populated country in Southern Europe
...
-- Italian -- Language spoken in this country
...
-- SMR -- countrycode that has 100% Italian as a language
SELECT *
FROM country
WHERE code = 'SMR';

-- San Marino -- the name of the contry
